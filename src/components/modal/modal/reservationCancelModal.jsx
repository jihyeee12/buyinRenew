        ...
        const fetchdetail = async () => {
            try {
                ...
                const response = await axios.post(
                     '/v2/cancelations',{reservation_id: id, cancel_reason: cancelReason},{headers:{'Contents-type': 'application/json','user': 'AppIDE00807557670'}}); //get은 data 넣을 자리 필요없으니까 안넣어도 됨
