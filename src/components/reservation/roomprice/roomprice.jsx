            ...
            <div className={styles.roomPriceInfo}>
                <div className={styles.roomInfo}>
                    ...
                    {room.room_images.map((roomImg, index) => (<>
                        <img className={styles.roomImg} key={roomImg.id} src={roomImg.room_img_url} onClick={() => linkRoom(room.room_id,checkin, checkout)} alt="roomprice" />
                    ...
                    <div className={styles.roomName} onClick={() => linkRoom(room.room_id, checkin, checkout)}>
                ...
                <div className={styles.hotelPriceBox} onClick={() => linkRoom(room.room_id, checkin, checkout)}>
