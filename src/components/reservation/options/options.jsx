            ...
            <table className={styles.roomOptionTable}>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><button type='button' className={styles.minus}>―</button><input className={styles.count} type="text" value={0}/><button type='button' className={styles.plus}>+</button></td>
                    </tr>
                    <tr>
        ...
        <div className={styles.amenityOption}>
            ...
            <div className={styles.amenities}>
                ...
                <div className={styles.selectAmenity}>
                    <input type="text" className={styles.amenityText} readOnly value={0} />
